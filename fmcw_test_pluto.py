...
class fmcw_test_pluto(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fmcw_test_pluto")
        ...
        self._tx_attenuation_range = qtgui.Range(0, 70, 1, 0, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SAW_WAVE, 1000, 0.7, 0, 0)
...
def main(top_block_cls=fmcw_test_pluto, options=None):
