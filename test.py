...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._freq_range = qtgui.Range(-1000000, 1000000, 1, 1, 200)
        ...
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_gr_complex*freq, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
