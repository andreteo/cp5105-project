...
class audo_fmcw_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_0 = epy_block_0.blk(samp_rate=samp_rate, bw=bw, duration=duration, total_samples=samp_rate * duration, duty_cycle=0.7)
        ...
        self.connect((self.blocks_multiply_conjugate_cc_0, 0), (self.qtgui_time_sink_x_1, 0))
        ...
        self.connect((self.epy_block_0, 0), (self.blocks_vco_c_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 200e3, 20e3, window.WIN_HAMMING, 6.76))
