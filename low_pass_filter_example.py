...
class low_pass_filter_example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "low_pass_filter_example")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 3*10**6
        self.center_frequency = center_frequency = 1*10**3
        self.N = N = 1024
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.iio_pluto_source_1 = iio.fmcomms2_source_fc32('ip:192.168.2.1' if 'ip:192.168.2.1' else iio.get_pluto_uri(), [True, True], 0x8000)
        ...
        self.iio_pluto_source_1.set_gain_mode(0, 'fast_attack')
...
def main(top_block_cls=low_pass_filter_example, options=None):
