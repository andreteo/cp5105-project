...
class andreteo(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "HR/BR Using Wireless and Machine Learning", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("HR/BR Using Wireless and Machine Learning")
        ...
        self.settings = Qt.QSettings("GNU Radio", "andreteo")
...
def main(top_block_cls=andreteo, options=None):
